                                ...
                                @foreach ($products as $product)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="#" onclick="confirm('Are you sure, you want to delete this Product?') || event.stopImmediatePropagation()" style="margin-left:10px;" wire:click.prevent="deleteProduct({{$product->id}})"><i class="fa fa-times 2x text-danger"></i> </a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
